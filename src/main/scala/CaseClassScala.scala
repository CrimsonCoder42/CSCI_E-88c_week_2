...
case class Employee(empno: Int, ename: String, sal:Int, gender:Char, dno:Int);

object CaseClassScala {

  // Case class is also a class
  // Created using the case keyword
  // all case class parameters by default are public.
